    ...
    pub fn clock(&mut self) {
        ...
        loop {
            ...
            match opcode {
                ...
                0x40 => self.RTI(AddressingMode::IMP), 0x41 => self.EOR(AddressingMode::ZPX), 0x45 => self.EOR(AddressingMode::ZP0), 0x46 => self.LSR(AddressingMode::ZP0), 0x48 => self.PHA(AddressingMode::IMP), 0x49 => self.EOR(AddressingMode::IMM), 0x4A => self.LSR(AddressingMode::ACC), 0x4C => self.JPM(AddressingMode::ABS), 0x4D => self.EOR(AddressingMode::ABS),
